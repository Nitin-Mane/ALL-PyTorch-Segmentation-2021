...
Welcome to the **Acute Lymphoblastic Leukemia Pytorch Segmentation 2021** official documentation.

<font color='red'>DEVELOPER TO EXPLAIN/UPDATE THE PROJECT DETAILS</font>

This documentation includes a [getting started guide](getting-started.md) and a step by step [installation guide for Python](installation/python.md) and [installation guide for Jupyter Notebook](installation/notebook.md).
